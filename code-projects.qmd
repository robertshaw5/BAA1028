...
<div class="landing-cards" role="list" style="grid-template-columns: 1fr; max-width: 56rem;">
  ...
  <a class="landing-card-link" href="machine-learning-project.html" role="listitem" aria-label="Open machine learning project page">
    <article class="landing-card">
  ...
  <a class="landing-card-link" href="dcu-timetable-to-apple-calender.html" role="listitem" aria-label="Open DCU timetable to apple calender page">
    <article class="landing-card">
